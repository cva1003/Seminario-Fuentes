...
defuncion_resp_total<-defuncion_resp %>%
  slice(3:54)%>%
  select(1,2)
print(defuncion_resp_total)

```
#### 4.1.1 Datos de defunciones por enfermedades respiratorias mujeres por provincia
...
print(defuncion_resp_total)
```
#### 4.1.1 Datos de defunciones por enfermedades respiratorias hombres por provincia
