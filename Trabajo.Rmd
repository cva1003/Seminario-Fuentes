...
```{r Mapa}
#nrow(provincias)  # Debería ser igual a la longitud de la columna 'parques'
#length(provincias$`Parques m²/hab`)  # También debería ser igual
#any(is.na(provincias$`Parques m²/hab`))
#provincias$`Parques m²/hab`<- as.numeric(provincias$`Parques m²/hab`)
...
```
### 4.8 Gráfico de barras apiladas de nº de hospitales con cantidad de zonas verdes.
