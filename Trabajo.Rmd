...
```
Visualizando el grafico anterior
...
ggplot(data = union_total, aes(x = Provincia )) +
  geom_line(aes(y = defunciones, group = 1, color="Defunciones totales")) +
  geom_line(aes(y = defunciones_mujeres, group = 1,color="Defunciones mujeres")) +
  geom_line(aes(y = defunciones_hombres, group = 1,color="Defunciones hombres")) +
  geom_line(aes(y = Numero_Hospitales, group = 1,color="numero hospitales")) +
  labs(title = "Relación entre defunciones y Número de Hospitales",
       x = "Provincias",
       y = "Cantidad")
```
