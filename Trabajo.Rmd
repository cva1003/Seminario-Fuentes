...
```{r}
ggplot(zonas_verdes, aes(x =reorder(Provincia,-`Parques m²/hab` ), y = `Parques m²/hab`)) +
...
```{r Lluvias por provincia, warning=FALSE, message=FALSE}
...
ggplot(datos_filtrados, aes(x = `Parques m²/hab`, y = Numero_Hospitales)) +
